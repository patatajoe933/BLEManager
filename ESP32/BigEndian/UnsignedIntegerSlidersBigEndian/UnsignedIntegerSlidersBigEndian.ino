...
#define SERVICE_UUID "000000F0-74ee-43ce-86b2-0dde20dcefd6"
// UUIDs for BLE characteristics
#define CHARACTERISTIC_SERVICE_NAME_UUID "100000F0-74ee-43ce-86b2-0dde20dcefd6"
#define CHARACTERISTIC_UINT8_UUID        "100000F1-74ee-43ce-86b2-0dde20dcefd6"
#define CHARACTERISTIC_UINT16_UUID       "100000F2-74ee-43ce-86b2-0dde20dcefd6"
...
void setup() {
  ...
  pCharacteristicServiceName->setValue("Big Endian Unsigned Integer Sliders");
  ...
  // uint8sliderbe: editable slider control for unsigned byte characteristics
  ...
  uInt8Descriptor->setValue(
    R"({"type":"uint8sliderbe", "order":1, "disabled":false, "label":"Unsigned Byte", "minInt":0, "maxInt":50, "stepInt":1})");  //Defaults: minInt = 0, maxInt = 100, stepInt: 1

  pCharacteristicUInt8->addDescriptor(uInt8Descriptor);
  uint8_t uint8 = 69;
  pCharacteristicUInt8->setValue(&uint8, sizeof(uint8_t));

  // uint16sliderbe: Editable slider control for unsigned int16 characteristics
  // If the characteristic is not writable, the "disabled" property is ignored, and the control remains disabled.
  ...
  uInt16Descriptor->setValue(
    R"({"type":"uint16sliderbe", "order":2, "disabled":false, "label":"Unsigned Int16", "minInt":0, "maxInt":50, "stepInt":2})");  //Defaults: minInt = 0, maxInt = 100, stepInt: 1
