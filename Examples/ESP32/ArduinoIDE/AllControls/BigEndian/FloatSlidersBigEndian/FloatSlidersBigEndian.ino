...
void setup() {
  ...
  halfDescriptor->setValue(
    R"({"type":"halfsliderbe", "order":1, "disabled":false, "label":"Float 16", "minFloat": 0, "maxFloat": 75, "stepFloat": 0.1})"); //Defaults: minFloat = 0, maxFloat = 100, stepFloat: 1
  ...
  floatDescriptor->setValue(
    R"({"type":"floatsliderbe", "order":2, "disabled":false, label:"Float 32", "minFloat": -50, "maxFloat": 50, "stepFloat": 1})"); //Defaults: minFloat = 0, maxFloat = 100, stepFloat: 1
