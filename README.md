...
Pokud má komonenta možnost omezení maxima a minima, výchozí nastavení opdovídá maximální a minimální hodnotě daného datového typu. U textu je výchozí maximální hodnota 512 bajtů. Každý haodnota descriptrou obsahuje vlastnost order. Order určuje pořadí zobrazení v aplikaci. Pokud není order nastaven, je pořadí určenou hdnotou UUID. Níže jsou uvedeny příklady jednotlivých nastavení s popisem chování.
Název služby
